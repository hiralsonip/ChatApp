...
import { User, Mail, MessageSquare, Lock, EyeOff, Eye, Shovel, Loader2 } from 'lucide-react';
...
const SignupPage = () => {
    ...
    const validateForm = () => {
        ...
        if (formData.password.length < 6) return toast.error("Password must be atleat 6 characters");
                    ...
                    <form onSubmit={handleSubmit} className='space-y-6'>
                        ...
                        <div className='form-control'>
                            ...
                            <div className="relative">
                                <div className="absolute top-1/2 left-0 pl-3 -translate-y-1/2 flex items-center pointer-events-none z-10">
                        ...
                        <div className='form-control'>
                            ...
                            <div className='relative'>
                                ...
                                <input type='email' className={`input input-bordered w-full pl-10`} placeholder='johndoe@email.com' value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} />
                            </div>
                        </div>
